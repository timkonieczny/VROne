 ...
 * @param {VROne.Scene} scene
 * @param {VROne.Object3D} geometry
 * @param {Number} quantity
 * @param {Number} prewarmTime
 * @class
 * @constructor
 */
VROne.ParticleSystem = function (scene, geometry, quantity, prewarmTime) {
    ...
    for(i=0;i<quantity;i++){
        this.particles.push(new VROne.Particle());
    }
...
VROne.ParticleSystem.prototype = new VROne.Object3D();
 ...
 * @constructor
 */
VROne.Particle = function () {
    this.position = new VROne.Vector3(0.0, 0.0, 0.0);
    this.rotationAngle = new VROne.Vector3(0.0, 0.0, 0.0);
    this.scale = new VROne.Vector3(1, 1, 1);

    this.vertices = [];
    this.colors = null;
    this.velocity = new VROne.Vector3(0.0,0.0,0.0);
    this.lifetime = 0.0;
    this.gravity = 0.0;
