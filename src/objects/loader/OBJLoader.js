 ...
 * @class
 * @param pathString
 * @returns {VROne.Object3D[]} object
 * @constructor
 */
VROne.OBJLoader = function (pathString) {
    //Modified version of THREE.js' OBJLoader
    var pathFile = /(.*[\/|\\])(.*)/;
    var path = pathFile.exec(pathString)[1];
    var file = pathFile.exec(pathString)[2];
    var objTxt = VROne.XMLLoader.getSourceSynch(path+file);
    var mtlName = this.getMtlName(objTxt);
    var mtlTxt = VROne.XMLLoader.getSourceSynch(path+mtlName);
...
//                console.log( "VROne.OBJLoader: Unhandled line " + line );
            }
        }
     ...
     * @param {} mtl
     * @param {} texturePath
     * @return {VROne.Object3D} object3D
     */
...
//        console.log("---");
        ...
        var object3D = new VROne.Object3D();
     ...
     * TODO: description
     * @param originO3D
     * @returns {VROne.Object3D}
     */
    copyOBJO3D: function(originO3D){
        var newO3D = new VROne.Object3D();
