 ...
 * @param {Number} near
 * @param {Number} far
 * @return {VROne.Matrix4} m
 */
VROne.Matrix4.makePerspective = function (fieldOfView, aspect, near, far) {
    var m = new VROne.Matrix4();
 ...
 * @return {VROne.Matrix4} m
 */
VROne.Matrix4.makeOrthoPerspective = function (left, right, top, bottom, near, far) {
 ...
 * @return {VROne.Matrix4} m
 */
VROne.Matrix4.makeVRPerspective = function (VRfov, zNear, zFar) {
...
VROne.Matrix4.prototype = {
    poolMatrix: new VROne.Matrix4(),
    poolVector3: new VROne.Vector3(),
    /**
     * Description
     */
    identity: function () {
     ...
     * @param {VROne.Vector3} axis
     * @param {VROne.Vector3} pivotPoint
     */
     ...
     * @param {VROne.Vector3} vector
     * @return {VROne.Vector3} vector
     */
     ...
     * @param {VROne.Matrix4} from
     * @param {VROne.Matrix4} to
     */
    ...
    /**
     * TODO: Converts VROne.Matrix4 to VROne.Matrix3
     * @param {VROne.Matrix4} toMatrix
     * @return {VROne.Matrix3} m3
     */
