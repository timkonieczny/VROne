 ...
 * @constructor
 */
VROne.Quaternion = function (x, y, z, w) {
    this.x = x || 0;
    this.y = y || 0;
    this.z = z || 0;
    this.w = w || 1;
...
VROne.Quaternion.prototype = {

    /**
     * Multiplies two quaternions
     * @param {VROne.Quaternion} qa
     * @param {VROne.Quaternion} qb
     */
     ...
     * @return {VROne.Quaternion} quaternion
     */
    normalize: function () {
        var x = this.x;
        var y = this.y;
     ...
     * TODO: Description
     * @param {VROne.Vector3} vector
     * @param {VROne.Vector3} target
     * @return {VROne.Vector3} v
     */
    getRotatedPoint: function(vector, target) {
        ...
        var v = target ? target : new VROne.Vector3();
    ...
    getConjugate: function(target){
        ...
        if(target){
            ...
            return new VROne.Quaternion(-this.x, -this.y, -this.z, this.w);
        }
    },
     ...
     * @returns {VROne.Vector3} vector
     */
    getForwardVector: function(){
        return new VROne.Vector3(
