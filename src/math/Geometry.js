 ...
 * @constructor
 */
VROne.Geometry = function () {
    this.position = new VROne.Vector3(0, 0, 0);
    this.rotation = new VROne.Quaternion();
    this.scale = new VROne.Vector3(1, 1, 1);
    this.offset = new VROne.Vector3(0, 0, 0);
};
VROne.Geometry.prototype = {};

/**
 * Creates box as new VROne.Object3D
 * @class
 * @constructor
 * @param {Number} a
 * @param {Number} b
 * @param {Number} c
 */
VROne.Geometry.Box = function (a, b, c) {
    VROne.Geometry.call(this);
...
VROne.Geometry.Box.prototype = new VROne.Geometry();
/**
 * Returns box geometry as VROne.Object3D
 * @param {Boolean} asWireframe
 * @return {VROne.Object3D} o3D
 */
VROne.Geometry.Box.prototype.getO3D = function (asWireframe) {

    var o3D = new VROne.Object3D();
    var o = this.offset;
    var a = this.a;
    var b = this.b;
    var c = this.c;
 ...
 * @param {VROne.Vector3} vector3
 * @return b1
 */
VROne.Geometry.Box.prototype.containsPoint = function (vector3) {
    ...
    var t1 = calcCorner(new VROne.Vector3(0, 0, 0));
    //    var t2 = calcCorner(new VROne.Vector3(this.a, 0, 0));
    var t3 = calcCorner(new VROne.Vector3(0, this.b, 0));
    var t4 = calcCorner(new VROne.Vector3(this.a, this.b, 0));

    var b1 = calcCorner(new VROne.Vector3(0, 0, this.c));
    var b2 = calcCorner(new VROne.Vector3(this.a, 0, this.c));
    var b3 = calcCorner(new VROne.Vector3(0, this.b, this.c));
    var b4 = calcCorner(new VROne.Vector3(this.a, this.b, this.c));
...
/**
 * Creates sphere geometry as VROne.Object3D
 * @class
 * @constructor
 * @param {Number} r
 */
VROne.Geometry.Sphere = function (r) {
    VROne.Geometry.call(this);

    this.r = r || 0;
};
VROne.Geometry.Sphere.prototype = new VROne.Geometry();
/**
 * Returns sphere geometry as VROne.Object3D
 * @param {Boolean} asWireframe
 * @param {Number} segments
 * @param {Number} rings
 * @return {VROne.Object3D} o3D
 */
VROne.Geometry.Sphere.prototype.getO3D = function (asWireframe, segments, rings) {
    this.scale = null;
...
/**
 * Creates grid of vertices as new VROne.Object3D. If splitSquares is true triangles are created as faces without sharing vertices.
 * @class
 * @constructor
 * @param {Number} a
 * @param {Number} b
 ...
 */
VROne.Geometry.Plane = function (a, b, xSubdivisions, ySubdivisions, splitSquares) {
    VROne.Geometry.call(this);
...
VROne.Geometry.Plane.prototype = new VROne.Geometry();
/**
 * Returns plane geometry as VROne.Object3D
 * @return {VROne.Object3D} o3D
 */
VROne.Geometry.Plane.prototype.getO3D = function () {
 ...
 */
VROne.Geometry.Icosahedron = function (subdivisions) {
    this.subdivisions = subdivisions;
    VROne.Geometry.call(this);
};
VROne.Geometry.Icosahedron.prototype = new VROne.Geometry();
/**
 * Returns icosahedron geometry as VROne.Object3D
 * @return {VROne.Object3D} o3D
 */
VROne.Geometry.Icosahedron.prototype.getO3D = function () {

    var o3D = new VROne.Object3D();

    var golden = new VROne.Vector2(0.5, ((1 + Math.sqrt(5)) / 2) - ((1 + Math.sqrt(5)) / 2) / 2);

    var a = new VROne.Vector2(
        -golden.x,  // left top
        golden.y); // -0.5, 0.9
    var b = new VROne.Vector2(
        golden.x,   // right top
        golden.y);  // 0.5, 0.9
    var c = new VROne.Vector2(
        -golden.x,   // left bottom
        -golden.y);  // -0.5, -0.9
    var d = new VROne.Vector2(
    ...
    a = new VROne.Vector3(0, 0, 0);
    b = new VROne.Vector3(0, 0, 0);
    c = new VROne.Vector3(0, 0, 0);
    var ab = new VROne.Vector3(0, 0, 0);
    var bc = new VROne.Vector3(0, 0, 0);
    var ac = new VROne.Vector3(0, 0, 0);
    var dist;
...
VROne.Geometry.CollisionMath = {};
VROne.Geometry.CollisionMath.ObjectPool ={
    corners1: [
        new VROne.Vector3(),
        new VROne.Vector3(),
        new VROne.Vector3(),
    ...
    edgeNormalV1:  new VROne.Vector3(),
    edgeNormalV2:  new VROne.Vector3()
};
/**
 * TODO: Description
 * @param {} outputVector
 ...
 * @param {} addC
 */
VROne.Geometry.CollisionMath.calcCorner = function (outputVector,boxGeo, addA, addB, addC) {
 ...
 * @param {} v
 */
VROne.Geometry.CollisionMath.calcNormal = function (outputVector, s, u, v) {
    var x1 = u.x-s.x,
        y1 = u.y-s.y,
        z1 = u.z-s.z,
        x2 = v.x-s.x,
 ...
 * @param {} sP
 */
VROne.Geometry.CollisionMath.getEdgeNormal = function (v, c1, c2, sP) {
    var v1 = VROne.Geometry.CollisionMath.ObjectPool.edgeNormalV1;
    v1.x = c2.x-c1.x;
    v1.y = c2.y-c1.y;
    v1.z = c2.z-c1.z;
    v1.normalize();
 ...
 * @return mtd
 */
VROne.Geometry.prototype.boxBoxCollision = function (box1, box2) {
    var calcCorner = VROne.Geometry.CollisionMath.calcCorner;
    var calcNormal = VROne.Geometry.CollisionMath.calcNormal;

    var corners1 = VROne.Geometry.CollisionMath.ObjectPool.corners1;
    ...
    var corners2 = VROne.Geometry.CollisionMath.ObjectPool.corners2;
    ...
    var normals = VROne.Geometry.CollisionMath.ObjectPool.normals;
    var normalsCount = 6;
 ...
 * @return mtd
 */
VROne.Geometry.prototype.boxSphereCollision = function (box, sphere, invert) {
    if(box.a === 0 || box.b === 0 || box.c === 0)invert = true;//TODO fix...

    var calcCorner = VROne.Geometry.CollisionMath.calcCorner;
    var calcNormal = VROne.Geometry.CollisionMath.calcNormal;
    var getEdgeNormal = VROne.Geometry.CollisionMath.getEdgeNormal;
 ...
 * @return Literal
 */
VROne.Geometry.prototype.sphereSphereCollision = function (sphere1, sphere2) {
