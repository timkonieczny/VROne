 ...
 * @constructor
 */
VROne.Renderer = function (canvas) {
...
//            if(!gl.ext)console.error("Can't get OES_vertex_array_object extension.");
     ...
     * @return {VROne.BufferMulti} bufferMulti
     */
    this.getBuffer = function(object3D, lightContainer){
        if(!object3D instanceof VROne.Object3D)throw "Can't get Buffer for " + object3D;

        return new VROne.BufferMulti(gl, object3D, lightContainer);
    };
