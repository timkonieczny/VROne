 ...
 * @param {VROne.CameraManager} cameraController
 * @class
 * @constructor
 */
VROne.VRRenderer = function (canvas, distorted, cameraController) {

    VROne.Renderer.call(this, canvas);

    var scope = this;

    var i = 0;

    var shaderPath =  "VROne/shader/";
    ...
    this.init = function(){
        ...
        vrSquare = new VROne.VRSquare();
        var vert = VROne.VRRenderer.prototype.vrCanvasVert;//VROne.XMLLoader.getSourceSynch(shaderPath + vrSquare.shader + ".vert");
        var frag = VROne.VRRenderer.prototype.vrCanvasFrag;//VROne.XMLLoader.getSourceSynch(shaderPath + vrSquare.shader + ".frag");
        shader = new VROne.Shader(gl, vert, frag);
        ...
        var config = new VROne.CameraModifier();
        config.getPosition().set(0, 0, 2.3);
        config.getOrientation().set(0, 0, 0, 1);
        
        var controller = new VROne.CameraManager();
        controller.modifiers.push(config);
        cameraDistortion = new VROne.Camera(controller);
     ...
     * Updates objects
     * @param {Camera} camera
     * @param {VROne.Object3D[]} objects
     * @param {VROne.Object3D[]} transparentObjects
     */
...
VROne.VRRenderer.prototype = new VROne.Renderer();
VROne.VRRenderer.prototype.vrCanvasVert = 
    ...
    "}";
VROne.VRRenderer.prototype.vrCanvasFrag =
