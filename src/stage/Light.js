...
VROne.LightContainer = function(){
    ...
    var poolPos = new VROne.Vector3();

    /**
     * Adds light to light container
     * @param {VROne.Light} light
     */
    ...
    this.update = function(camera){
        ...
        if(camera.useVR){
            ...
            for(i=0; i<lights.length; i++){
                VROne.Vector3.prototype.copyToVector(lights[i].position, poolPos);
...
VROne.LightContainer.prototype = {};