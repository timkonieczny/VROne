 ...
 * @constructor
 */
VROne.Sound = function(audioPath) {

    var scope = this;
    this.soundLoaded = false;
    this.position = new VROne.Vector3(0,0,0);
    this.orientationFront = new VROne.Vector3(0,0,0);
    this.orientationUp = new VROne.Vector3(0,1,0);
    this.listenerPosition = new VROne.Vector3(0,0,0);
    this.listenerOrientationFront = new VROne.Vector3(0,0,0);
    this.listenerOrientationUp = new VROne.Vector3(0,1,0);
    this.loop = true;
    this.is3D = true;
    this.volume = 1;
    ...
    /**
     * Loads audio file
     * @param {VROne.AudioContext} audioContext
     */
