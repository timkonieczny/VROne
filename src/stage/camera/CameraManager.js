...
VROne.CameraManager = function () {
    ...
    this.isInputVR = function(){
        for(i=0; i<this.modifiers.length; i++){
            if(this.modifiers[i] instanceof VROne.WebVR){
                return true;
            }
        }
        return false;
    ...
    this.update = function(){
        ...
        for(i=0; i<this.modifiers.length; i++){
            if(!isHMDInitialized && this.modifiers[i] instanceof VROne.WebVR){
