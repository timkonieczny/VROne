 ...
 * @constructor
 */
VROne.MouseHandler = function(){

    var scope = this;

    this.addedMovement = new VROne.Vector2(0,0);
    this.movement = new VROne.Vector2(0,0);
...
var lastMovement = new VROne.Vector2(0,0);
var movement = new VROne.Vector2(0,0);
var x = 0;
var y = 0;
var newFrame = true;
 ...
 * @returns {VROne.Vector2}
 */
VROne.MouseHandler.getMovement = function(){
 ...
 */
VROne.MouseHandler.setNewFrameTrue = function(){
    newFrame = true;
};